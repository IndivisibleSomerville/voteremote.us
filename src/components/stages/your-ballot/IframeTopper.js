...
const IframeTopper = (props) => {
    if (props.formName === 'Verify Your Registration') {
        return (
            <div>
                <div class="form_header_headline_box">
                ...
                <div class="form_header_description_box">
                    ...
                    <button class="vr_section_subhead">I Registered</button>
                    <button class="vr_section_subhead">I Printed My Form</button>
                </div>
            </div>
        )
    }
        ...
        return (
            <div>
                ...
                <div class="form_header_description_box">
                    ...
                    <button class="vr_section_subhead">I Requested My Ballot</button>
                    <button class="vr_section_subhead">I'll Vote in Person</button>
                </div>
            </div>
        )
    }
