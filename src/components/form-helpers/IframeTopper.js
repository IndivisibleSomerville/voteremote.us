        ...
        return (
            <div>
                ...
                <div class="form_description_box">
                    ...
                    <button class="form_button form_button_no_background" onClick={ () => {props.handleStepChange('PrefillAbsenteeRequest')} }>I'm All Set! Get me an absentee ballot request!</button>
                    <button class="form_button form_button_no_background" onClick={ () => {props.handleStepChange('Finished')} }>I'm All Set! And I'll be voting in person.</button>
                    </div>
                </div>
            </div>
        )
        ...
        return (
            <div>
                ...
                <div class="form_description_box">
                    ...
                    <div class="iframe_topper_button_container">
                        <button class="form_button form_button_no_background" onClick={ () => {props.handleStepChange('Finished')} }>I'm All Set!</button>
                    </div>
                </div>
            </div>
        )
